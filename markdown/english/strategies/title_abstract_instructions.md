The title and abstract are designed to give you a general idea of what a paper is about. It is a good idea to skim-read the abstract first, to decide if you want to read more.

This also gives a good summary of work done! No need to pass it to generative AI!
...
">
  ...
  <ul style="margin:8px 0 0 18px; color:#2f3f52;">
    <li>Determine if this study is relevant to your reading (in this case, let's pretend it is 😜)</li>
  </ul>
</div>
...
<div style="
  ...
  margin: 16px 0;
">
⚠️ <strong>Warning:</strong> Abstracts summarise what the authors thought was important and can sometimes make the research sound more outstanding than it was. It is important to not rely only on an abstract.
</div>
