your_turn_paper3_ui <- function(id) {
  ns <- NS(id)
  ...
  bslib::page_fluid(
    ...
    card(
      full_screen = TRUE,
      card_header("Hornsby et al., 2026"),
      card_body(
        navset_tab(
          id = ns("reading_tabs"),
          nav_panel(
                ...
                card_body(
                  div(
                      ...
                      div(
                        ...
                        uiOutput(ns("paper3_title_abstract"))
                      )
                    )
                )
              )
                ...
                card_body(
                  div(
                      ...
                      div(
                        class = "paper-box",
                        highlighter_toolbar_ui(".prose"),
                        uiOutput(ns("paper3_introduction"))
                      )
                    )
                )
              )
            ...
            sidebar = sidebar(
              ...
              gap = "1px",
                ...
                div(
                  ...
                  paperstars_rating_ui(
                    id = ns("data_presentation_rating_paper3"),
            ...
            sidebar = sidebar(
              ...
              gap = "1px",
                ...
                div(
                  ...
                  tags$h4("Discussion"),
                  paperstars_rating_ui(
                    id = ns("discussion_rating_paper3"),
                ...
                div(
                  ...
                  tags$h4("Limitations"),
                  paperstars_rating_ui(
                    id = ns("limitations_rating_paper3"),
            ...
            sidebar = sidebar(
              ...
              div(
                ...
                div(
                  ...
                  paperstars_rating_ui(
                    id = ns("data_available_rating_paper3"),
...
your_turn_paper3_server <- function(id, process_markdown, process_rmd_fragment) {
  ...
  output$paper3_title_abstract <- renderUI({
    md_ui("english/your_turn/paper3/paper3_title_abstract.Rmd")
  })

  output$paper3_introduction <- renderUI({
    md_ui("english/your_turn/paper3/paper3_intro.Rmd")
  })

  output$paper3_methods <- renderUI({
    md_ui("english/your_turn/paper3/paper3_methods.Rmd")
  })

  output$paper3_results <- renderUI({
      md_ui("english/your_turn/paper3/paper3_results.Rmd")
    })
  
  output$paper3_discussion <- renderUI({
    md_ui("english/your_turn/paper3/paper3_discussion.Rmd")
  })
...
data_presentation_mod <- paperstars_rating_server(
  id = "data_presentation_rating_paper3",
  weight = 3,
  choiceNames = data_presentation_choices$names,
  choiceValues = data_presentation_choices$values
)
...
data_available_mod <- paperstars_rating_server(
  id = "data_available_rating_paper3",
  weight = 4,
  choiceNames = data_available_choices$names,
  choiceValues = data_available_choices$values
)
...
rating_mods <- list(
  title_rating_paper3 = title_mod,
  methods_rating_paper3 = methods_mod,
  stats_rating_paper3 = stats_mod,
  data_presentation_rating_paper3 = data_presentation_mod,
  discussion_rating_paper3 = discussion_mod,
  limitations_rating_paper3 = limitations_mod,
  data_available_rating_paper3 = data_available_mod
)
